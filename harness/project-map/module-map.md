...
| app\analyzer\llm_assistant.py | LLM API 基础设施（调用/配置/Key检测/tool-use） | _load_dotenv, _get_llm_config, _call_llm, _call_llm_with_tools, check_api_key_available | - |
...
| app\analyzer\dimension_analyzer.py | 聚焦三维度分析引擎（架构/用户故事/风险），CodeGraph 上下文增强 | analyze_architecture, analyze_user_stories, analyze_risk | - |
